...
def create_indexes():
    ...
    db.simple_decks.create_index([("owner_id", 1), ("created_at", -1)])
    db.simple_decks.create_index([("title", "text"), ("description", "text")])
    db.simple_cards.create_index([("deck_id", 1), ("order_index", 1)])
    db.simple_cards.create_index([("front", "text"), ("back", "text")])
    db.simple_card_stats.create_index([("user_id", 1), ("card_id", 1)], unique=True)
    db.simple_card_stats.create_index([("user_id", 1), ("deck_id", 1)])
    db.simple_card_stats.create_index([("user_id", 1), ("forget_count", -1)])
    db.simple_learning_sessions.create_index([("user_id", 1), ("started_at", -1)])
    db.simple_learning_sessions.create_index([("user_id", 1), ("deck_id", 1), ("started_at", -1)])
